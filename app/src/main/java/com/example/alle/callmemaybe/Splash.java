package com.example.alle.callmemaybe;
...
public class Splash extends AppCompatActivity implements OnConnectionFailedListener, View.OnClickListener, ConnectionCallbacks {
    public GoogleApiClient google_api_client;
    public GoogleApiAvailability google_api_availability;
    ...
    */
    ...
    public void onConnectionFailed(ConnectionResult result) {
         Log.v("Okay", "GoogleApiClient connection failed: " + result.toString());
        if(result != null){
